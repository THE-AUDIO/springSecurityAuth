package com.theaudio.springSecurityAuth.controllers;
...
public class LoginController {
    ...
    private StringBuffer getOauth2LoginInfo(Principal user, OidcUser oidcUser){
        ...
        if(authenticationToken.isAuthenticated()){
            Map<String, Object> userAtributes = ((DefaultOAuth2User) authenticationToken.getPrincipal()).getAttributes();
            OidcIdToken idToken = oidcUser.getIdToken();
            if(idToken != null){
                protectedInfo.append("id token value " + idToken.getTokenValue() + " <br> <br>");
                protectedInfo.append("Maped values <br> <br>");
            ...
            protectedInfo.append("Welcome , " + userAtributes.get("name") + "<br> <br>");
            protectedInfo.append("Email ," + userAtributes.get("email") + "<br> <br>");
